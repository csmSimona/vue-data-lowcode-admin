...
export function setupCustomComponents(app: App) {
  ...
  app.component('StackMap', StackMap);
  app.component('Pseudo3DMap', StackMap);
  ...
  app.component('StackMapOption', StackMapOption);
  app.component('Pseudo3DMapOption', StackMapOption);
}
